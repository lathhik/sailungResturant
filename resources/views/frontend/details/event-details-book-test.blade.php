...
{{--                                    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name" placeholder="Full Name *">--}}
{{--                                </div>--}}
...
{{--                                <div class="size30 bo2 bo-rad-10 m-t-3 m-b-30">--}}
{{--                                    <input class="bo-rad-10 sizefull txt10 p-l-20" type="tel" name="contact" placeholder="Contact *">--}}
{{--                                </div>--}}

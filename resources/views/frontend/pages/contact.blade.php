        ...
        <div class="container">
            ...
            <div class="row p-t-135">
                <div class="col-sm-8 col-md-4 col-lg-4 m-l-r-auto p-t-30">
                    <div class="dis-flex m-l-23">
                        <div class="p-r-40 p-t-6">
                            <img src="{{asset('custom/frontend/images/icons/map-icon.png')}}" alt="IMG-ICON">
                        </div>
                ...
                <div class="col-sm-8 col-md-3 col-lg-4 m-l-r-auto p-t-30">
                    <div class="dis-flex m-l-23">
                        <div class="p-r-40 p-t-6">
                            <img src="{{asset('custom/frontend/images/icons/phone-icon.png')}}" alt="IMG-ICON">
                        </div>
                ...
                <div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
                    <div class="dis-flex m-l-23">
                        <div class="p-r-40 p-t-6">
                            <img src="{{asset('custom/frontend/images/icons/clock-icon.png')}}" alt="IMG-ICON">
                        </div>

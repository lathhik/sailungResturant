                    ...
                    <div class="item-slick1 item1-slick1"
                        ...
                        <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                            ...
                            <div class="wrap-btn-slide1 animated visible-false" data-appear="zoomIn">
                                ...
                                <a href="{{route('blog-details',$pop_blog->id)}}"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-9">
                    ...
                    @foreach($blogs_by_cat as $blog)
                        <!-- Block4 -->
                            <div class="blo4 p-b-63">
                                <div class="pic-blo4 hov-img-zoom bo-rad-10 pos-relative">
                                    <a href="blog-detail.html">
                                        <img src="{{asset('custom/backend/images/blog/'.$blog->blog->image)}}"
                                             alt="IMG-BLOG">
                                    </a>
                                    @php
                                        $date_time = \Carbon\Carbon::parse($blog->blog->created_at)
                                    @endphp
                                ...
                                <div class="text-blo4 p-t-33">
									...
									<span>
                                        ...
                                        <span>
										{{count($blog->blog->comments)}} Comments
									</span>
                                    </div>

                                    <p>
                                        {!! str_limit($blog->blog->description,500) !!}
                                        {{--                                        @php--}}
                                        {{--                                            echo htmlspecialchars_decode(str_limit($blog->description,500))--}}
                                        {{--                                        @endphp--}}
                                    </p>
                                    <a href="{{route('blog-details',$blog->blog->slug)}}" class="dis-block txt4 m-t-30">
                                        Continue Reading

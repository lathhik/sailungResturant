...
@section('content')
    ...
    <section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15"
             style="background-image: url(custom/frontend/image/about1.jpg);">
    ...
    <!-- Banner -->
    <div class="parallax0 parallax100" style="background-image: url(custom/frontend/image/chef_kitchen.jpg);">
                    ...
                    <div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
                        ...
                        <div class="blo5 pos-relative p-t-60">
                            <div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
                                <a href="#"><img src="{{asset('custom/backend/images/employee/'.$chef->image)}}"
                                                 alt="IGM-AVATAR"></a>
                            </div>
